...
$bmpResized.Save($imageTarget.Replace('.png','m.png').Replace('.jpg','m.png').Replace('.jpeg','m.png').Replace('.JPG','m.png').Replace('.JPEG','m.png').Replace('.PNG', 'm.png'), $imageFmt::Png)
