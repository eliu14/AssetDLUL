...
$bmpResized.Save($imageTarget.Replace('.jpg','m.png').Replace('.jpeg','m.png').Replace('.JPG','m.png').Replace('.JPEG','m.png').Replace('.PNG', 'm.png').Replace('.png','m.png'), $imageFmt::Png)
