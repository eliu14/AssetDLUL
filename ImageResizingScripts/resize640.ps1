...
$bmpResized.Save($imageTarget.Replace('.jpg','l.png').Replace('.jpeg','l.png').Replace('.JPG','l.png').Replace('.JPEG','l.png').Replace('.PNG', 'l.png').Replace('.png','l.png'), $imageFmt::Png)
